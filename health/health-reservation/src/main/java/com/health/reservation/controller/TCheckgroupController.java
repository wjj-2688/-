...
public class TCheckgroupController extends BaseController
{
    ...
    @PostMapping
    public AjaxResult add(@RequestBody TCheckgroupDto tCheckgroupDto)
    {
        return toAjax(tCheckgroupService.insertTCheckgroup(tCheckgroupDto));
    }
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody TCheckgroupDto tCheckgroupDto)
    {
        return toAjax(tCheckgroupService.updateTCheckgroup(tCheckgroupDto));
    }
